...
function App() {
    ...
    return (<div className="App">
        ...
        <div style={{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center"}}>
            ...
            <div style={{height: 300, width: 1100, display: "flex", flexDirection: "row", marginBottom: 50, justifyContent:"space-between"}}>
            ...
            <div style={{ marginTop:100}}>
                <NavLink to={"/join"}>
                    ...
                    <motion.button whileHover={{scale:1.3, opacity:0.5}} style={{backgroundColor: "#386FA4",height:70, width:150, border:"none", borderRadius:5 ,fontWeight:600 ,marginRight:100}}>Join</motion.button>
                </NavLink>
                <NavLink to={"/newgame"}>
                <motion.button whileHover={{scale:1.3, opacity:0.5}} style={{backgroundColor: "#",height:70, width:150, border:"none", borderRadius:5, fontWeight:600 ,}}>New</motion.button>
                </NavLink>
            </div>
